...
public:
	// Constructor
	MyImage();
	MyImage(int w, int h, char* data = NULL);
	// Copy Constructor
	...
	bool    ReadImageFromPointer(char* start);
	bool	WriteImageToPointer(char* start);
	bool	WriteImage();
	bool	WriteImage(FILE* file);
	bool    averageFiltering(FilterParam params);
	bool	imageFilter();
	// Modifications
	bool	Modify();
